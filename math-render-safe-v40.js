...
(function(){
 ...
 function pow(a,b){return `<span class="qpow" dir="ltr" style="display:inline-block;position:relative;unicode-bidi:isolate;white-space:nowrap;vertical-align:baseline;line-height:1;padding-top:.18em;padding-inline-start:.28em"><span class="qbase" dir="ltr" style="display:inline-block">${esc(ar(a))}</span><sup dir="ltr" style="position:absolute;left:0;top:-.28em;font-size:.58em;line-height:1;unicode-bidi:isolate">${esc(ar(b))}</sup></span>`}
 function render(raw){
