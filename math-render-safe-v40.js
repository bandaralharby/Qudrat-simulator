...
(function(){
 ...
 function pow(a,b){return `<span class="qpow" dir="ltr" style="display:inline-flex;align-items:flex-start;unicode-bidi:isolate;white-space:nowrap;vertical-align:baseline;line-height:1"><span class="qbase" dir="ltr" style="display:inline-block;order:1">${esc(ar(a))}</span><sup dir="ltr" style="display:inline-block;order:2;position:static;transform:translateY(-.48em);margin-left:.04em;font-size:.58em;line-height:1;unicode-bidi:isolate">${esc(ar(b))}</sup></span>`}
 function render(raw){
