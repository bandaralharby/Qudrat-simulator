...
(function(){
 ...
 function render(raw){let s=String(raw??'').replace(/[0-9]/g,d=>D[d]),holds=[];const hold=h=>{const key=`QQHOLD${String.fromCharCode(65+holds.length)}ZZ`;holds.push([key,h]);return key};
